...
namespace Pustota.Maven.Serialization
{
	...
	{
		internal void SaveToElement(IProjectReference projectReference, XElement element)
		{
		...
		//private void SaveProject(IProject project, ProjectObjectModel element)
		//{
		//	XElement root = pom.Root;
