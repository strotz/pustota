...
namespace Pustota.Maven.Base.Tests.Validations
{
	...
	public class ParentSpecificVersionTests
	{
		...
		public void Initialize()
		{
			...
			_validation = new ParentSpecificVersionValidation(_project.Object);
		}
